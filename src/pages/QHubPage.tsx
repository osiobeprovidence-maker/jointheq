...
export default function QHubPage() {
    ...
    if (!accessCheck.hasAccess) {
        return (
            <MainLayout activeTab="qhub" setActiveTab={(tab) => { if (tab === 'admin') navigate('/admin'); else navigate('/dashboard'); }} qScore={user?.q_score}>
                <div className="bg-white rounded-[2rem] p-8 shadow-sm text-center max-w-lg mx-auto mt-20">
